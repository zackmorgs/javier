...
export default function Footer() {
  ...
  return (
    <footer id="footer">
      <div className="xl:max-w-7xl mx-auto px-4 sm:px-6">

        {/* Top area: Blocks */}
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">

          {/* 1st block */}
          <div className="footer-section sm:col-span-12 lg:col-span-3">
            <div className="mb-2">
              <Logo />
            </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Social as */}
          <ul id="social-items" className="flex mb-4 md:order-1 md:ml-4 md:mb-0">

            {/* todo: make a twitter */}
            {/* <li>
              <Link id="twitter" href="#0" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter">
            ...
            <li className="ml-4">
              <Link href="https://www.facebook.com/p/Javiers-Barbershop-100066316638906/" target="_blank" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
